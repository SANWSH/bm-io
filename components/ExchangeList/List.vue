    ...
    <div class="wrapper">
        <exchange-list-wrapper class="hero">
            <article class="h-full">
                ...
                <div
                    class="frame mt-auto h-max flex relative self-center p-1 items-center border-white border-opacity-20 border rounded-2xl">
                    <b-button class="typography-x" type="Primary" size="M" text="Оставить отзыв" />
                </div>
            </article>
