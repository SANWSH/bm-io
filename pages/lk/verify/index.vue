...
function addImage(event) {
  ...
  reader.onload = () => {
    ...
    const fileObject = createObject(file.name, imageUrl, file.size)
...
<template>
  <div class="verify-page">
    ...
    <div class="verify-panel">
      ...
      <div ref="form" class="verify-form">
        <h3 class="subtitle">Добавить новую карту</h3>
        <form class="flex-form" @submit.prevent="addNewCard">
          <misc-b-dropdown class="form-input-1" />
          ...
          <input id="fileInput" ref="fileExplorer" type="file" accept="image/png, image/jpeg, image/gif, image/webp"
          ...
          <div class="uploaded-files">
            <div v-for="img, i in uploaded" :key="i" class="uploades-wrapper" :data-index="i"
              :style="`background-image: url(${img.source})`" @click="deleteCurrentFile($event.target)">
