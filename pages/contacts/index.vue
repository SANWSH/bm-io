...
const quantityElements = ref(dropdown)
    ...
    <div class="contacts-page">
        <div class="contacts-header">
            <div class="contacts-header-media">
                ...
                <div class="contacts-header-media-item">
                    <div class="media-dropdown-wrapper" ref="dropdownWrapper">
                        <h1 class="font-semibold text-2xl">
                            Форумы
                        </h1>
                        <div class="media dropdown">
                            <div class="media-dropdown-content" ref="dropdown">
                                <NuxtLink to="//telegram.web" class="media-link">
        ...
        <div class="contacts-cards-container">
            <div class="contacts-card" v-for="card in cards" :key="card.title" :style="`background-image: url(${getImageUrl(card.img)})`">
...
<style lang="scss">
    ...
    /* media */
    .media-link,.media-info,.media-dropdown{
        display: flex;
        @include toRem(border-radius, 15);
